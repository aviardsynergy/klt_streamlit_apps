...
st.text('Janvier à Septembre : RAS')
st.text('Octobre : données de prédictions manquantes, le réel est bon. Je vais voir avec Ingrid dans les jours prochains pour rajouter la prédiction')
st.text('Novembre : RAS')
st.text('Décembre : Le montant mis en REEL_NPROD est l\'objectif du mois')
